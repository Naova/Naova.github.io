...
.. code-block:: console
   ...
   git clone git@github.com:Naova/NaovaWebots.git
...
5. You can copy `booster-runner-full-webots-k1-0.0.1.run` from the Downloads folder to the Webots installation directory (e.g., /usr/local/webots) and run it to configure the Webots-K1 environment before each simulation session.
